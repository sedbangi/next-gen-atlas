``` json
{
	...
	"A.1.4.1.0.3.1": {
		"Name": "Anon Dilemma FacilitatorDAO Action Example",
		"Version": 1,
		"Type": "FacilitatorDAO Action Example",
		"Components": {
			"Input": "One AC owns shares as a business angel in a potential Ecosystem Actors company. The AC is not disclosing this anywhere when the Ecosystem Actors product is being proposed onboarded as an Ecosystem Actor serving the NEWDAO ecosystem. The reason is the AC on one side can not reveal its identity and on the other side has a requirement to make a disclosure of this ownership. This later comes to knowledge of a FacilitatorDAO.",
			"Output": "The FacilitatorDAO determines what role the AC had and how the AC acted when the proposal was being voted on. Since the AC was an AD and for that specific proposal abstained from voting without stating the actual reason on the forum, the FacilitatorDAO decides to do nothing.",
			"Label": "Aligned"
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
	...
	"A.1.4.3.0.2": {
        ...
        "Components": {
            "List of Elements and their Element Analysis Documents": {
                "Worst Case Scenario Element Analysis": "A.1.4.3.0.2.1",
				"Warning Reasoning Element Analysis": "A.1.4.3.0.2.2",
				"Prompt Act Element Analysis": "A.1.4.3.0.2.3",
				"Slippery Slope Element Analysis": "A.1.4.3.0.2.4",
				"Held to the Highest Standard Element Analysis": "A.1.4.3.0.2.5"
            }
        },
	...
	"A.1.4.3.0.2.1": {
		"Name": "Worst Case Scenario Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "Governance Attack",
		  "Analysis": "A “Governance Attack” represents a critical violation of the NEWDAO ecosystem's governance protocols, far surpassing minor misalignments. This term is reserved for actions with the potential to severely compromise the ecosystem's foundational structure and operational integrity. Unlike simple non-compliance with scope articles, a Governance Attack is characterized by deliberate efforts to destabilize or exploit the governance framework. It involves strategically orchestrated actions that aim not just to breach the rules, but to erode the balance of powers established among ACs, thus threatening the very essence of the NEWDAO's governance model."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.4.3.0.2.2": {
		"Name": "Warning Reasoning Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "a warning may be given",
		  "Analysis": "The decision to issue a warning is not at the discretion of an individual Facilitator representing the FacilitatorDAO. It is not based on their personal preference. Instead, the uniqueness of each case is considered, and these differences can be crucial in determining the outcome. However, precedent cases cited in the child document to this article greatly influence the decision. If the precedent case is founded on a specific scope that has since been changed, the significance of this case is adjusted accordingly."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.4.3.0.2.3": {
		"Name": "Prompt Act Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "Immediately",
		  "Analysis": "The term 'immediately,' in the context of FacilitatorDAOs derecognizing Alignment Conservers, is contingent upon the risk and extent of damage that could be caused by the relevant Alignment Conserver. Situations where the damage extends beyond reputational harm are considered emergency contexts, such as casting votes and transferring funds. In cases that are not deemed emergencies, 'immediately' should be interpreted as 'as soon as is reasonably possible,' acknowledging and accommodating any practical limitations or requirements that might necessitate a slight delay. However, in emergency contexts, 'immediately' must be explicitly understood to mean instantaneously, or without any intervening time."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.4.3.0.2.4": {
		"Name": "Slippery Slope Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "Slippery Slope",
		  "Analysis": "The element defines a type of misalignment or rule breach that, while minor in isolation, can lead to a cascade of more significant and potentially severe issues within the system. Recognition of a slippery slope transgression is a preventive measure, maintaining organizational integrity while offering leeway for small-scale aberrations. This affords situation-specific lenience as a means for continuous improvement while protecting the NEWDAO ecosystem from severe misalignments or governance attacks. An ambiguity arises, however, from a degree of subjectivity around what constitutes a mild breach or slippery slope, which may need defining for clarity to prevent abuse or discordance in enforcement practices."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.4.3.0.2.5": {
		"Name": "Held to the Highest Standard Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "Held to the Highest Standard",
		  "Analysis": "This element regarding an AC is targeted within the enforcement principles and regulations of the Atlas. This imposes a level of ethics, performance, and responsibility that far surpasses the average, promoting an extremely high bar for conduct within the ecosystem. Breach of these set standards marks a failure in alignment with the universal principles of the ecosystem and leads to punitive action such as stripping an AC’s recognition. Therefore, the principle of accountability cannot be softened for Alignment Conservators, as milder standards for their roles would potentially shake the protective pillars of decentralization, transparency and integrity within the DAO, eventually risking the overall stability and reputation of the ecosystem."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.4.3.0.3.3": {
		"Name": "Slippery Slope Realignment Action Example",
		"Version": 1,
		"Type": "FacilitatorDAO Action Example",
		"Components": {
			"Input": "An Aligned Delegate has been known to present information that seems questionable occasionally. It doesn't result in harm or loss; however, some AVCs express discomfort. Instead of catching the issue at first, AVCs have noted each event as a mild oversight. Over time, a collage of these situations builds up, creating considerable uncertainty around the AC's authenticity and transparency. Doubts are raised about the consistent dedication to living up to the rigorous standards of an AC, invoking conversations about possible realignment actions.",
			"Output": "Since the Aligned Delegate has yet to do something explicitly violating the principles or resulting in harm or loss, the FacilitatorDAO decides to let them continue in their role without any warnings. The doubts around this AC's actions reflect a lack of understanding rather than indicative of purposeful deceit. The FacilitatorDAO concludes that while the AC should aspire to improve and minimize future questionable situations, the delegate needs minimum realignment actions as they have upheld all other rigorous standards associated with an AC.",
			"Label": "Misaligned",
			"Penalty": 500000,
			"Penalty_Reason": "The FacilitatorDAO's decision to overlook a potential misalignment situation due to the lack of harm must be in alignment with the strict requirements in the Target Document for Alignment Conservers. Continuous questionable behavior and the discomfort it has caused other members of the Aligned Voter Committees indicate a lack of genuine alignment in fulfilling the required functions of the role. The dismissal due to an intuitive judgment of lack of harm downplays the severity of continuous behavior classified as a mild 'slippery slope' breach, underscoring the need to address such actions promptly. FacilitatorDAO, in this case, should have, at a minimum, issued a warning as indicated in the document to discourage and realign the AC, potentially eliminating the chronic behavior that jeopardizes their alignment and ultimately. Even if no bad intentions or incompetence is suspected, the standards and official warnings should have been reiterated to maintain the Atlas rules. The FacilitatorDAO's lenient stand in the face of emerging misalignment requires judgment as 'Misaligned.' The standards set in the Atlas require the highest promise of alignment. Thus, temporary lapses or circumvention of rules are grounds for warning and correction irrespective of the perceived damage caused."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.4.4.0.2": {
		...
		"Components": {
			"List of Elements and their Element Analysis Documents": {
				...
				"High Levels of Opsec Element Analysis": "A.1.4.4.0.2.2"
			}
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [
	...
	"A.1.4.4.0.2.2": {
		"Name": "High Levels of Opsec Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "High levels of opsec",
		  "Analysis": "The phrase, 'high levels of opsec' refers to an advanced and meticulous approach to security, essential for maintaining the anonymity and integrity of certain Alignment Conserver roles. This phrase encompasses a comprehensive set of practices such as secure communication channels, stringent data encryption, anonymity tools like VPNs and TOR networks, regular security audits, and rigorous digital footprint management. These practices ensure that sensitive information about the ACs’ activities and identities is safeguarded against unauthorized access or exposure. Within the Atlas, this requirement is not merely a suggestion but a critical mandate, especially for ACs in roles that demand absolute discretion. The insistence on 'high levels of opsec' highlights the Atlas's prioritization of security as a fundamental aspect of governance integrity. It underscores that ACs must go beyond basic security measures, adopting industry-standard or even military-grade security practices to protect the governance process from vulnerabilities and external influences. By defining 'high levels of opsec' as a requirement, the Atlas establishes a clear expectation for ACs, emphasizing their responsibility in actively maintaining security protocols that align with the highest standards. This serves to fortify the governance structure against potential breaches, thereby upholding the trust and efficacy of the Maker ecosystem’s decentralized governance model."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.5.0.2": {
        ...
        "Components": {
            "List of Elements and their Element Analysis Documents": {
                "Normal Conditions Element Analysis": "A.1.5.0.2.1",
				"Formal Powers Element Analysis": "A.1.5.0.2.2",
				"Subjective Definition of Universal Alignment Element Analysis": "A.1.5.0.2.3"
            }
        },
        "Last_Modified": "2023-11-22-00:00:00",
        "Child_Documents": [
	...
	"A.1.5.0.2.1": {
		"Name": "Normal Conditions Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "Normal Conditions",
		  "Analysis": "This element pertains to the regular, day-to-day operations of the governance process. It encompasses activities such as routine voting cycles, standard decision-making, and typical governance tasks. In essence, 'normal conditions' refer to situations where the governance process functions as expected, without any extraordinary events or crises that require emergency measures or interventions. Deviations from normal conditions include experiencing a large-scale governance attack, encountering situations that pose a reasonable risk of destroying the entire ecosystem, or facing non-routine events that result in unprecedented losses to the ecosystem or have the potential to lead to such losses. This element within the context of the Target Document leads to the conclusion that AVCs are suited to make key decisions and be in control during normal conditions; in non-ordinary conditions, they are not so suited. This is because, during normal conditions, the primary focus is on marginal governance improvement. However, in non-normal conditions, the primary focus shifts to reacting and responding to the unique challenges presented by the situation at hand."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.5.0.2.2": {
		"Name": "Formal Powers Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "Formal Powers",
		  "Analysis": "This element pertains to the authorized abilities or authorities granted within the governance framework. The term 'formal' simply signifies that these powers are officially acknowledged and derived from the Atlas. It is important to note that these powers for AVCs are not physical in nature, as AVCs do not directly cast votes themselves. Instead, they play a guiding role by providing direction to delegates through their Aligned Scope Proposals and Aligned Governance Strategy documents. These powers for AVCs encompass the interpretation of Universal Alignment and the application of this interpretation to facilitate the enhancement of the Atlas, ultimately aiming to foster increased alignment through the creation of Aligned Scope Proposals and Aligned Governance Strategy documents."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.5.0.2.3": {
		"Name": "Subjective Definition of Universal Alignment Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "subjective definition of Universal Alignment",
		  "Analysis": "The phrase 'subjective definition of Universal Alignment' in the Atlas context refers to the individual interpretations of Universal Alignment by different actors within the MakerDAO ecosystem, particularly the Aligned Voter Committees (AVCs). While Universal Alignment is a foundational concept of the MakerDAO governance structure, its subjective nature acknowledges that different actors may have varying perspectives on what constitutes alignment with the ecosystem's core values and objectives. This subjective aspect is intentionally circumscribed within a framework that ensures these interpretations remain consistent with the overarching principles of the Atlas. The term 'subjective' does not imply arbitrariness or unrestrained discretion; rather, it denotes a structured flexibility that allows for diverse interpretations while safeguarding against deviations that could harm the integrity of the ecosystem. By defining this term with precision and embedding checks and balances within the governance structure, the Atlas aims to protect against misinterpretation, governance attacks, or malicious intent. The subjective definition of Universal Alignment must always be exercised in a manner that is transparent, justifiable, and in harmony with the collective ethos of the MakerDAO community, ensuring that even varied interpretations contribute constructively to the ecosystem's stability and resilience."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.5.1.0.2": {
        ...
        "Components": {
            "List of Elements and their Element Analysis Documents": {
				...
				"Broader Aligned Structure Element Analysis": "A.1.5.1.0.2.2"
            }
        },
        "Last_Modified": "2023-11-22-00:00:00",
        "Child_Documents": [
	...
	"A.1.5.1.0.2.2": {
		"Name": "Broader Aligned Structure Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "Broader Aligned Structure",
		  "Analysis": "Broader Aligned Structure refers to the entire structure of the governance of the ecosystem, particularly the components involved in upholding Alignment. This includes all Alignment Conservers, the Atlas, and AVC documents. This excludes Ecosystem Actors, DAI holders, and MKR holders, and any other type of ecosystem participant that does not play a direct part in upholding Alignment."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.5.2.0.3.2": {
		"Name": "AD is Accused of Going Against the Aligned Governance Strategy",
		"Version": 1,
		"Type": "FacilitatorDAO Action Example",
		"Components": {
			"Input": "An AD submits a vote going against the Aligned Governance Strategy from the AVC it has established one of its EGL with, according to some of the AVC members",
			"Output": "The FacilitatorDAO gives the AD a warning for misalignment, stating the accusation",
			"Label": "Misaligned",
			"Penalty": 10000,
			"Penalty_Reason": "The FacilitatorDAO cannot just be utilized as a tool by an AC, it must collect all information needed to be able present its independent view. In this case, the FacilitatorDAO is being corrected for not having collected all relevant information and included these facts and the opposing view from the AD in its reasoning."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
    ...
    "A.1.5.8.0.2": {
        ...
        "Components": {
            "List of Elements and their Element Analysis Documents": {
				...
				"Hidden Conflict of Interest Element Analysis": "A.1.5.8.0.2.7",
				"AVCs Overstepping Their Roles Element Analysis": "A.1.5.8.0.2.8"
            }
        },
        "Last_Modified": "2023-11-22-00:00:00",
        "Child_Documents": [
	...
	"A.1.5.8.0.2.7": {
		"Name": "Hidden Conflict of Interest Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "Hidden Conflict of Interest",
		  "Analysis": "A 'hidden conflict of interest' as stated in A.1.5.8 refers to a situation where an individual or group in a position of trust has competing interests or loyalties that are not disclosed to those who depend on their honesty. In the context of AVC governance, such conflicts may compromise the integrity of decisions, as actions could be taken that benefit the individual or group at the expense of the collective good. The concealment of these conflicts represents a significant threat to the principles of transparent and equitable governance, as it undermines the trust necessary for effective collaboration and alignment with the Atlas's objectives. It is imperative for AVCs to have mechanisms in place to identify and address any hidden conflicts of interest to maintain fairness and impartiality in governance processes and that breaches of these rules are dealt with swiftly."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.5.8.0.2.8": {
		"Name": "AVCs Overstepping Their Roles Element Analysis",
		"Version": 1,
		"Type": "Element Analysis",
		"Components": {
		  "Element": "AVCs Overstepping Their Roles",
		  "Analysis": "The risk of 'AVCs overstepping their roles' is outlined in A.1.5.8, which cautions against AVCs' engagement in micromanagement and the imposition of biased conditions. Overstepping is identified as actions taken by AVCs that contravene the established governance boundaries, leading to potential micromanagement or the creation of biased or unfair conditions, directly or indirectly through biased processes. Such overreach may manifest in exerting undue influence, making decisions beyond their remit, or engaging in governance actions that should be reserved for a broader consensus or different governance bodies. This behavior is antithetical to the Atlas's decentralized and equitable ethos, potentially leading to centralization of power and distortion of the intended governance processes. It is crucial to have safeguards and clear role definitions to prevent AVCs from overstepping, thereby ensuring that governance remains balanced, transparent, and aligned with the collective objectives of the Maker Ecosystem. A.1.5.8 mandates the deactivation of AVCs and derecognition of members in instances of clear misalignment, thereby serving as a deterrent and a mechanism for correction."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
	...
	"A.1.5.8.0.3.1": {
		"Name": "Are the Conditions Fair or Unfair?",
		"Version": 1,
		"Type": "FacilitatorDAO Action Example",
		"Components": {
		  "Input": "An AVC submits a proposal to add additional requirements for Scope Advisor, with these changes applied only a few candidates seems suited for the role.",
		  "Output": "The FacilitatorDAO gives the AVC a warning for mild misalignment, applying the argument that the conditions are unjustified. However this argument is not manifested in anything else than the FacilitatorDAOs personal judgement of the case.",
		  "Label": "Misaligned",
		  "Penalty": 100000,
		  "Penalty_Reason": "Several AC roles are keeping each other in check; ADs, AVC members, and maybe even a Scope Advisor are involved in the process of drafting the proposal for a scope amendment. The AVC is, for this part of the governance process, granted a judicial discretion which cannot be overruled by a FacilitatorDAO if no new information or clear manifestation of an unjustified decision can be presented."
		},
		"Last_Modified": "2023-11-22-00:00:00",
		"Child_Documents": [],
		"links_to": {},
  ...
  "A.1.10": {
    ...
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Article",
    "Components": {
      "Content": "This Article covers principles, processes and roles related to the correct and secure execution of NEW Ecosystem Governance Processes, protecting it against all forms of attacks, disruption and accidental failure. It aims to create a resilient equilibrium where the cost and difficulty of attacks always outweighs the potential reward for attackers."
    }
  },

  "A.1.10.1": {
    "Name": "NEWDAO Executive Vote Process", 
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Section",
    "Components": {
      "Content": "This Section covers the executive vote process used by NEWDAO to make modifications to its protocol state. Due to the significant value and impact of the protocol, and the risk of hacks, bugs or technical failure that is possible, NEWDAO Executive Votes must always be with a uncompromising focus on security and due diligence, with no tolerance for shortcuts or anything less than extremely strict adherence to all principles and rules, and the Spirit of the Atlas."
    }
  },

  "A.1.10.1.1": {
    "Name": "Executive Vote Frontend Requirements",
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "The frontend used for NEWDAO Executive Votes must have extensive documentation of its technical specifications, architecture, access controls, and processes. It must undergo regular audits by approved security partners. Modifications must be minimized, with a focus on longevity and stability. Alternative frontends are permitted but must meet the documentation and audit requirements. Exec frontends are controlled by FacilitatorDAOs and their responsible AllocatorDAOs frontends." 
    }
  },

  "A.1.10.1.1.1": {
    "Name": "List of Correctness Requirements",
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "The Executive Vote Frontends must conform to all requirements contained as subdocuments nested below this Document." 
    }
  },

  "A.1.10.1.1.2": {
    "Name": "Executive Vote Frontend Data Archiving",
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "All infrastructure and processes related to the Executive Vote Frontends must save and maintain all relevant data in order to make it possible to monitor and verify their security." 
    }
  },

  "A.1.10.1.1.3": {
    "Name": "Executive Vote Frontend Penalties",
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "Failing to follow the Executive Vote Frontend Requirements is one of the most damaging and dangerous failures a FacilitatorDAO can cause, and as a result there are strict rules related to penalties for breaching best practice or causing unsafe situations." 
    }
  },  

  "A.1.10.1.2": {
    "Name": "Executive Vote Process",
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core", 
    "Components": {
      "Content": "FacilitatorDAOs must follow a strict process for reviewing and approving Executive Votes before they are included in the Executive Vote Frontends, made available for vote by regular MKR holders and approved for voting by ADs. The process involves extensive sanity checks, risk analysis, confirmation of technical details, and ensuring alignment with the Atlas. FacilitatorDAOs may veto proposals that fail to meet the approval criteria."
    }
  },
  "A.1.10.1.2.1": {
    "Name": "Executive Vote Process Instance Step Specifications",
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core", 
    "Components": {
      "Content": "The Executive Vote Approval Process covers 5 main process steps: 1) Exec Sheet (Initial action payload specification), 2) Testnet Approval, 3) Exec Doc (final action payload specification), 4) Mainnet Approval and 5) Frontend Approval. Each of these process steps are covered in detail in the subdocuments nested below this document. They must be followed exactly as specified in every new Active Executive Vote Workstream"
    }
  },
  "A.1.10.1.2.1.1": {
    "Name": "Exec Sheet (Initial Action Payload Specification)",
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",    
    "Type": "Core",
    "Components": {
      "Content": "The Exec Sheet contains key details and instructions for the executive vote. It is created by FacilitatorDAOs and provided to Crafters as the basis for implementing the executive vote code." 
    }
  },

  "A.1.10.1.2.1.1.1": {
    "Name": "Exec Sheet structure",
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",    
    "Type": "Core",
    "Components": {
      "Content": "The Exec Sheet must be structured with all information available as specified in this Document and its nested Subdocuments." 
    }
  },

  "A.1.10.1.2.1.1.2": {
    "Name": "Atlas Document Action Interpretation",
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",    
    "Type": "Core",
    "Components": {
      "Content": "The Exec Sheet is populated based on interpretation of contents of the Atlas that specify the conditions for including Executive Vote Action Payloads." 
    }
  },

  "A.1.10.1.2.1.1.3": {
    "Name": "Executive Vote Action Payload prioritization and timing",
    "Version": 1,
    "Last Modified": "2023-08-16-19:07:00",    
    "Type": "Core",
    "Components": {
      "Content": "Executive Votes need to have their security prioritized above all else, and as a result it is necessary to carefully prioritize which Action Payloads to include in each Executive Vote Workstream based on their relative importance and time sensitivity. The Subdocuments nested below this document specify the key principles that the Governance FacilitatorDAOs must follow in determinining the practical composition of the Exec Sheet contents for each Executive Vote Workstream in the context of prioritization." 
    }
  },

  "A.1.10.1.2.1.2": {
    "Name": "Testnet Executive Vote development, deployment and Approval", 
    "Version": 1, 
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "Once the Exec Sheet has been finalized the Executive Vote Crafter develops and deploys the Testnet Executive Vote Code based on the Exec Sheet. Simultaneously, the code undergoes meticulous review by Executive Vote Reviewers and FacilitatorDAOs against the instructions and intended outcomes. All discrepancies must be addressed before approving the Testnet Executive Vote."
    }
  },

  "A.1.10.1.2.1.2.1": {
    "Name": "Testnet Executive Vote Development", 
    "Version": 1, 
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "The Crafter must develop an Executive Vote codebase that is fully compliant with the Exec Sheet according to the rules of the Executive Vote Development Instructions."
    }
  },

  "A.1.10.1.2.1.2.2": {
    "Name": "Testnet Executive Vote crafter pre-deployment checklist", 
    "Version": 1, 
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "When the Crafter has finished the development of the Executive Vote Codebase for the Executive Vote Process Instance they must fill the Crafter pre-deployment checklist and submit it to the FacilitatorDAOs. If the course of following the checklists results in issues being found with the testnet executive vote codebase, then the process must restart and the crafter must develop and submit a new codebase that solves the problem."
    }
  },

  "A.1.10.1.2.1.2.3": {
    "Name": "Testnet Executive Vote reviewer pre-deployment checklist", 
    "Version": 1, 
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "When the Crafter has submitted their pre-deployment checklist the 2 reviewers must each follow and submit their reviewer pre-deployment checklists to the FacilitatorDAOs. If the course of following the checklists results in issues being found with the testnet executive vote codebase, then the process must restart and the crafter must develop and submit a new codebase that solves the problem."
    }
  },

  "A.1.10.1.2.1.2.4": {
    "Name": "Testnet Executive Vote deployment", 
    "Version": 1, 
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "When all pre-deployment checklists have been successfully submitted, the crafter must deploy the Testnet Executive Vote on an approved testnet."
    }
  },

  "A.1.10.1.2.1.2.5": {
    "Name": "Testnet Executive Vote crafter post-deployment checklist", 
    "Version": 1, 
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "When the Crafter has finished the deployment of the Executive Vote of the Executive Vote Process Instance they must fill the Crafter post-deployment checklist and submit it to the FacilitatorDAOs. If the course of following the checklists results in issues being found with the testnet executive vote, then the process must restart and the Crafter must start over with a new codebase that solves the problem(s) found."
    }
  },

  "A.1.10.1.2.1.2.6": {
    "Name": "Testnet Executive Vote reviewer post-deployment checklist", 
    "Version": 1, 
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "When the Crafter has submitted their post-deployment checklist the 2 reviewers must each follow and submit their reviewer post-deployment checklists to the FacilitatorDAOs. If the course of following the checklists results in issues being found with the testnet executive vote, then the process must restart and the Crafter must start over with a new codebase that solves the problem(s) found."
    }
  },

  "A.1.10.1.2.1.2.7": {
    "Name": "Testnet Executive Vote Execution", 
    "Version": 1, 
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "When all post-deployment checklists have been successfully submitted, the crafter must Execute the deployed Testnet Executive Vote."
    }
  },

  "A.1.10.1.2.1.2.8": {
    "Name": "Testnet Executive Vote Crafter Post-Execution Checklist", 
    "Version": 1, 
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "When the Crafter has Executed the Testnet Executive Vote of the Executive Vote Process Instance they must fill the Crafter Post-Execution Checklist and submit it to the FacilitatorDAOs. If the course of following the checklists results in issues being found with the testnet executive vote, then the process must restart and the Crafter must start over with a new codebase that solves the problem(s) found."
    }
  },

  "A.1.10.1.2.1.2.9": {
    "Name": "Testnet Executive Vote reviewer Post-Execution Checklist", 
    "Version": 1, 
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "When the Crafter has submitted their Post-Execution Checklist the 2 reviewers must each follow and submit their reviewer Post-Execution Checklists to the FacilitatorDAOs. If the course of following the checklists results in issues being found with the testnet executive vote, then the process must restart and the Crafter must start over with a new codebase that solves the problem(s) found."
    }
  },

  "A.1.10.1.2.1.2.10": {
    "Name": "Testnet Executive Vote FacilitatorDAO approval", 
    "Version": 1, 
    "Last Modified": "2023-08-16-19:07:00",
    "Type": "Core",
    "Components": {
      "Content": "When all Post-Execution Checklists have been successfully submitted, the FacilitatorDAOs must review entire process and approve that it was completed in full compliance with the Spirit of the Atlas, and that the Executive Vote Process Instance can continue without posing any risk to the Ecosystem."
    }
  },

  "A.1.10.1.2.1.3": {
    "Name": "Exec Doc (Final Action Payload Specification)",
    "Version": 1,
    "Type": "Core",
    "Components": {
      "Content": "The Exec Doc provides the final specifications of the Action Payloads that must be implemented in the mainnet Executive Vote Codebase." 
    }
  },

  "A.1.10.1.2.1.3.1": {
    "Name": "Exec Sheet copy",
    "Version": 1,
    "Type": "Core",
    "Components": {
      "Content": "The Exec Doc provides the final specifications of the Action Payloads that must be implemented in the mainnet Executive Vote Codebase." 
  ...
  "A.1.10.1.2.4": {
    "Name": "Mainnet Executive Vote Approval",
    "Version": 1, 
    "Type": "Core",
    "Components": {
      "Content": "After approval of the test executive vote, the process is repeated for the mainnet vote using an approved mainnet frontend. Additional audits may be required along with a mandatory external audit." 
    }
  },
  "A.1.10.1.2.5": {
    "Name": "Final Approval and Frontend Inclusion",
    "Version": 1,
    "Type": "Core", 
    "Components": {
      "Content": "After the mainnet executive vote code is approved, the Exec Doc is finalized and the proposal is included in the approved frontend for the community vote. Extensive checks occur before and during the voting period."
    }
  },
  "A.1.10.1.3": {
    "Name": "Executive Vote Development Process",
    "Version": 1,
    "Type": "Section", 
    "Components": {
      "Content": "The Governance Security Process is crucial for secure development and execution of executive votes. It involves defined roles, checklists, audits, and standards that aim to minimize risks."
    }
  },
  "A.1.10.1.3.2": {
    "Name": "Roles",
    ...
    "Type": "Section",
    "Components": {
      "Content": "The Governance Security Process relies on Ecosystem Actors fulfilling the Crafter and Reviewer roles. These roles have strict requirements and responsibilities essential for executing executive votes securely. Must be governance security approved ecosystem actor"
    }
  },
  ...
  "A.1.10.1.3.1.1": {
    ...
    "Type": "Core",
    "Components": {
      "Content": "The Crafter is responsible for translating instructions from FacilitatorDAOs into executable code. They must intimately understand the technical specifications of the protocol and write optimally secure code. Crafters must complete training and be certified before participating."
    }
  },
  ...
  "A.1.10.1.3.1.2": {
    ...
    "Type": "Core", 
    "Components": {
      "Content": "The Reviewer is responsible for meticulously reviewing code produced by the Crafter. They act as a second set of eyes, ensuring adherence to all technical and security specifications. Reviewers must complete training and be certified before participating."
    }
  },
  ...
  "A.1.10.1.3.4": {
    ...
    "Type": "Section",
    "Components": {
      "Content": "The Governance Security Checklist Process uses checklists to clearly and explicitly specify requirements that must be completed, and publicly reported, by Crafters and Reviewers for every executive vote. They represent best practices that reduce risks when followed correctly, and failure to follow the instructions of the checklists dilligently and in alignment with teh Spirit of the Atlas triggers penalties for the responsible FacilitatorDAOs."
    }
  },

  "A.1.10.1.3.2.1": {
    "Name": "Checklist General Principles",
    "Version": 1,
    "Type": "Core",
    "Components": {
      "Content": "The Checklists aim to balance security with practicality. They must be exhaustive yet digestible. Checklists are living documents, updated based on new risks. Completion is mandatory, with explanations required for unchecked items."
    }
  },
  "A.1.10.1.3.3": {
    "Name": "External Audit and Review Requirements",
    "Version": 1,
    "Type": "Section", 
    "Components": {
      "Content": "In addition to the Crafter and Reviewer, executive vote code must also undergo audits by certified external security partners. Bug bounties are mandatory for critical modules. Formal verifications should be pursued when feasible."
    }
  },

  "A.1.10.1.4": {
    "Name": "Executive Vote voting and execution security",
    "Version": 1,
    "Type": "Core", 
    "Components": {
      "Content": "When an Executive Vote has been deployed and exposed in the Executive Vote frontends, there are multiple security processes that must be followed by Governance FaciltatorDAOs and ADs to monitor and react to any risks."
    }
  }, 

  "A.1.10.1.4.1": {
    "Name": "Aligned Delegate spell involvement requirements",
    "Version": 1,
    "Type": "Core", 
    "Components": {
      "Content": "ADs have to follow specific requirements for voting on Executive Votes. They must vote to support and execute the vote if they determine it is aligned with the Spirit of the Atlas and safe for the ecosystem, and they must use their voting power to prevent it from executing it and initiate action to penalize the FacilitatorDAOs if they determine it is misaligned and against the Spirit of the Atlas or could cause direct or indirect harm to the ecosystem."
    }
  }, 
  "A.1.10.1.4.2": {
    "Name": "Governance Security Delay security requirements",
    "Version": 1,
    "Type": "Core", 
    "Components": {
      "Content": "After Executive Votes are executed, the FacilitatorDAOs and Aligned Delegates must monitor the Executive Vote Action Payload and trigger a Executive Vote cancellation if issues are detected."
    }
  }, 
  "A.1.10.1.5": {
    "Name": "Emergency Executive Votes",
    "Version": 1,
    "Type": "Core", 
    "Components": {
      "Content": "In emergency conditions, such as in response to a governance attack or technical risk, the FacilitatorDAOs and ADs must coordinate to deploy and execute an Emergency Executive Vote, and can override the necessary security requirements depending on the severity of the risks. Abuse of this power is heavily penalized."
    }
  }, 
  "A.1.10.2": {
    "Name": "SubDAO Executive Vote Process",
    "Version": 1,
    "Type": "Section",
    "Components": {
      "Content": "This Section covers executive voting processes used by SubDAOs. While SubDAOs have autonomy, their executive vote processes must follow minimum security principles outlined here to prevent misuse of funds or other resources delegated to them from the Core NEWDAO."
    }
  },
  "A.1.10.3": {
    "Name": "Governance Security Ecosystem Actors", 
    "Version": 1,
    "Type": "Section", 
    "Components": {
      "Content": "The Executive vote processes of NEWDAO and SubDAOs require a diverse market of independent ecosystem actors offering various forms of governance security services to ensure that all of the independent checks and balances in the executive vote processes can be correctly followed and will have their intended effect. This section details the requirements for Ecosystem Actors to be approved for Governance Security work."
    }
  },

  "A.1.10.3.1": {
  "Name": "Governance Security Contributor Ecosystem Principles",
  "Version": 1,
  "Type": "Core",
  "Components": {
    "Content": "The NEWDAO Governance Security Contributor Ecosystem aims to cultivate a community of skilled individuals and organizations that provide essential security services for the executive voting process. This document outlines key principles for ecosystem development:"
  }
},

"A.1.10.3.2": {
  "Name": "Governance Security Ecosystem Actor Approval Process",
  "Version": 1, 
  "Type": "Core",
  "Components": {
    "Content": "All ecosystem actors providing security services for the NEWDAO executive voting process must be approved through the following process before participating:"
  }
},
  "A.1.10.4": {
    "Name": "Governance Security culture and research",
    "Version": 1,
    "Type": "Section", 
    "Components": {
      "Content": "Maintaining resilient security requires extensive ongoing research and a culture focused on security. Principles and processes to incentivize security research and risk factors related to long term security culture, science and technical breakthroughs are covered in this Section."
    }
  },
     "A": {
        "Name": null,
